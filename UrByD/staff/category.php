        ...
        <div class="col">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">ตารางประเภทสินค้า</h3>
                </div>
                <div class="col text-right">
                  <a href="category_create.php" class="btn btn-primary">เพิ่มประเภทสินค้า</a>
                </div>
              </div>
            </div>
                ...
                ?>
                  <tr>
                    ...
                    <td class="budget text-center">
                        <a  href="category_edit.php?category_id=<?php echo $result["category_id"] ?>" class="btn btn-info">
                        <i class="ni ni-scissors"> แก้ไข</i>
                        </a>
                      
                        <a href="JavaScript:if(confirm('คุณต้องการลบ <?php echo $result["category_name"];?> หรือไม่')==true){window.location='/\UrByD/service/category_service.php?action=delete_category&category_id=<?php echo $result["category_id"] ?>';}" class="btn btn-danger" ><i class="fa fa-minus-circle"> ลบ</i></a>
