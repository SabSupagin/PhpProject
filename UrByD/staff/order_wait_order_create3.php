    ...
    <div class="container-fluid mt--6">
      <div class="row">
        <div class="col">
              ...
              <table class="table align-items-center table-flush">
	            ...
	            ?>
                  <tr>
                    ...
                    <td width="90">
                        <input type="number" class="form-control" name="Qty<?php echo $i;?>" value="<?php echo $_SESSION["strQty"][$i];?>" size="2" style="text-align: center;" 
                        min="1" max="<?php echo $result["product_stock"];?>" >
                    </td>

                    <td class="budget text-right"><?php echo number_format($Total,2);?></td>
		            <td class="budget text-center">
                        <a href="<?php echo STAFF_URL ?>order_wait_order_create6.php?Line=<?php echo $i ?>" class="btn btn-danger"><i class="fa fa-trash-o"> ลบ</i></a>
                    </td>
            ...
            <form action="order_wait_order_create5.php" method="post">
            <a class="btn btn-warning" href="javascript:$('#form-create-unit').submit();">คำนวนราคาใหม่</a>
                <button class="btn btn-success " >สั่งสินค้า</button>
            </form>
