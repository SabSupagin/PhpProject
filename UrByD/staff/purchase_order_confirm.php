        ...
        <div class="col">
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col"> 
                  <h3 class="mb-0">รับสินค้า <?php echo $strID; ?></h3> 
                </div>
                <div class="col text-right">
                  <!-- <a href="<?php echo STAFF_URL ?>purchase_order_create3.php" class="btn btn-warning">รายการสั่งซื้อสินค้า</a> -->
                </div>
              </div>
            </div>
            ...
            <div class="table-responsive">
              <table class="table align-items-center table-flush">
                ...
                ?>
                  <tr>
                  <form action="purchase_order_create2.php" method="post">
                    ...
                    <td  class="text-center">
                      <input type="submit" value="เพิ่ม" class="btn btn-info">
                    </td>
	                </form>
