        ...
        <div class="col">
            ...
            <form id="form-confirm-purchase" class="form-horizontal" method="POST" action="\UrByD/service/purchase_service.php">
              <div class="row align-items-center">
                <div class="col">
                    <h3 class="mb-0">รับสินค้า <?php echo $po_id; ?> </h3>
            ...
            <div class="table-responsive">
                  ...
                  <tr>
                    ...
                    <td class="budget text-right"><?php echo number_format($rt["product_qty"],0);?></td> 
                        <input type="hidden" class="form-control" name="product_qty[]" value="<?php echo $rt['product_qty'] ?>" 
                                size="2" />
                    <!--<td width="100">
                        <input type="number" class="form-control" name="product_qty2[]" value="<?php echo $rt['product_qty'] ?>" 
                                size="2" />
                    </td>-->
                    <td width="90">
                        <select name="product_qty2[]" class="form-control" >
                        <option value='<?php echo $rt['product_qty'] ?>'><?php echo $rt['product_qty'] ?></option>
                        <?php
                            $n = 0;
                            while ($n <= $rt['product_qty'] ){
                        ?>
                            <option value='<?php echo $n;?>'><?php echo $n;?> </opton>
                        <?php $n++; } ?>
              ...
              <h4 class="budget text-right" >รวมทั้งหมด <?php echo number_format($SumTotal,2);?> บาท</h4>
                ...
                <div class="panel-footer">
                        <a class="btn btn-success" onclick="return confirm('คุณต้องการรับสินค้า หรือไม่')" href="javascript:$('#form-confirm-purchase').submit();">บันทึก</a>
