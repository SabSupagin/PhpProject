...
$sql = "SELECT p.*,c.category_name ,s.supplier_name ,un.unit_name
        FROM aby_product p
        INNER JOIN aby_category c on c.category_id = p.category_id
        INNER JOIN aby_unit un on un.unit_id = p.unit_id
        INNER JOIN aby_supplier s on s.supplier_id = p.supplier_id ";
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <a href="purchase_order_create.php" class="btn btn-primary">เพิ่มการสั่งซื้อสินค้า</a>
                </div>
              </div>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                ?>
                  <tr>
                    ...
                    <td class="budget text-center">
                        <a  href="purchase_order_create2.php?product_id=<?php echo $result["product_id"]&'act=add' ?>" class="btn btn-info">
